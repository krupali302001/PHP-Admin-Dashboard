...
// Logo          
    ...
    $output .= '<table style="width:100%; border: 0.2px solid black;">';
      ...
      $output .= '<tr>';
        ...
        $output .= '<td style=" border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">'. $row["firstName"] .'</td>';
      $output .= '</tr>';
      $output .= '<tr>';
        $output .= '<th style=" border-top: 0.2px solid black; height:17px" align="left">Last Name :</th>';
        $output .= '<td style="border-top: 0.2px solid black;border-left: 0.2px solid black; height:17px" align="left">'. $row["lastName"] .'</td>';
      $output .= '</tr>';
      $output .= '<tr>';
      ...
      $output .= '<tr>';
        ...
        $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px"align="left">'. $row["department"] .'</td>';
      $output .= '</tr>';
      $output .= '<tr>';
        $output .= '<th style="border-top: 0.2px solid black; height:17px" align="left">Email:</th>';
        $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px"  align="left">'. $row["email"] .'</td>';
      $output .= '</tr>';
      $output .= '<tr>';
      ...
      $output .= '<tr>';
         ...
         $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px" align="left">'. $row["DOB"]->format('Y-m-d') .'</td>';
       $output .= '</tr>';
       $output .= '<tr>';
      ...
      $output .= '<tr>';
        ...
        $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px" align="left">'. $row["marital_status"] .'</td>';
      $output .= '</tr>';
...
$pdf->Output($row["firstName"].'-resume.pdf', 'I');
